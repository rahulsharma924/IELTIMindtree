...
public class ContentFragmentContent {
	...
	@RequestAttribute(name = "cfInput4")
	private String cfInput4;

	@PostConstruct
	protected void init() {
		if (cfInput1 != null && !cfInput1.isEmpty() && cfInput2 != null && !cfInput2.isEmpty() && cfInput3 != null
				&& !cfInput3.isEmpty() && cfInput4 != null && !cfInput4.isEmpty()) {
			getCFMData(cfInput1, cfInput2, cfInput3, cfInput4);
		} else {
			getCFMPublishedData();
		}
	}
	...
	public void getCFMData(String cfInput1, String cfInput2, String cfInput3, String cfInput4) {
		cfInput1 = cfInput1 + CFM_RESOURCES_PATH;
		cfInput2 = cfInput2 + CFM_RESOURCES_PATH;
		cfInput3 = cfInput3 + CFM_RESOURCES_PATH;
		cfInput4 = cfInput4 + CFM_RESOURCES_PATH;
		String[] CFPaths = { cfInput1, cfInput2, cfInput3, cfInput4 };
		try {
