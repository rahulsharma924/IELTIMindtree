...
import static com.aem.ie.core.constants.ServletConstants.OLCC_GET_SEARCH_OPTIONS;
...
@Component(service = Servlet.class, property = { Constants.SERVICE_DESCRIPTION + "=OLCC Get Search Options",
		...
		ServletResolverConstants.SLING_SERVLET_PATHS + "=" + OLCC_GET_SEARCH_OPTIONS,
		ServletResolverConstants.SLING_SERVLET_EXTENSIONS + "=json"

})
public class OLCCGetSearchOptionsServlet extends SlingAllMethodsServlet {

	private static final Logger log = LoggerFactory.getLogger(OLCCGetSearchOptionsServlet.class);
	...
	protected void doPost(final SlingHttpServletRequest slingRequest, final SlingHttpServletResponse slingResponse)
		...
		slingResponse.getWriter().write(olccModuleService.getSearchOptions(jsonData, bearerToken));
	}
}
