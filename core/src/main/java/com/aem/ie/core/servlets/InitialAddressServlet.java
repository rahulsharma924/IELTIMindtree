...
import static com.aem.ie.core.constants.ServletConstants.INITIAL_ADDRESS;
...
@Component(service = Servlet.class, property = { Constants.SERVICE_DESCRIPTION + "=CT Integration servlet",
		...
		ServletResolverConstants.SLING_SERVLET_PATHS + "=" + INITIAL_ADDRESS,
		ServletResolverConstants.SLING_SERVLET_EXTENSIONS + "=json"

})
public class InitialAddressServlet extends SlingAllMethodsServlet {

	private static final Logger log = LoggerFactory.getLogger(InitialAddressServlet.class);
	@Reference
	...
	protected void doPost(final SlingHttpServletRequest slingRequest, final SlingHttpServletResponse slingResponse)
		...
		try {
			...
			responseValue = addNewAddressService.initialAddressDetails(slingRequest, accessToken, bearerToken);
