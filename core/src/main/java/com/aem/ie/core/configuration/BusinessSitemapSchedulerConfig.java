...
@ObjectClassDefinition(name = "Business SiteMap Scheduler Configuration")
public @interface BusinessSitemapSchedulerConfig {
    @AttributeDefinition(name = "Business SiteMap Scheduler Scheduler")
