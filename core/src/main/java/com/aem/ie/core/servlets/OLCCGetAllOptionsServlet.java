...
import static com.aem.ie.core.constants.ServletConstants.OLCC_GET_ALL_OPTIONS;
...
@Component(service = Servlet.class, property = { Constants.SERVICE_DESCRIPTION + "=OLCC Get All Options",
		ServletResolverConstants.SLING_SERVLET_METHODS + "=" + HttpConstants.METHOD_GET,
		ServletResolverConstants.SLING_SERVLET_PATHS + "=" + OLCC_GET_ALL_OPTIONS,
		ServletResolverConstants.SLING_SERVLET_EXTENSIONS + "=json"

})
public class OLCCGetAllOptionsServlet extends SlingAllMethodsServlet {

	private static final Logger log = LoggerFactory.getLogger(OLCCGetAllOptionsServlet.class);
	...
	protected void doPost(final SlingHttpServletRequest slingRequest, final SlingHttpServletResponse slingResponse)
		...
		slingResponse.getWriter().write(olccModuleService.getAllOptions(jsonData, bearerToken));
	}
