...
class WireTransferPaymentServletTest {
    ...
    @InjectMocks
    WireTransferPaymentServlet wireTransferPaymentServlet;
    ...
    void doPostTest() throws ServletException, IOException {
            ...
            String MockClearCartResponse = iectViewPaymentService.choosePayment(CTCustomerToken, bearerToken, jsonData);
            when(mockIectViewPaymentService.choosePayment(Mockito.anyString(), Mockito.anyString(), Mockito.anyString())).thenReturn(MockClearCartResponse);
            ...
            wireTransferPaymentServlet.doPost(request,response);
          }
