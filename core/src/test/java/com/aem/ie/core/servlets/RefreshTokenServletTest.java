...
import com.aem.ie.core.services.impl.RefreshTokenServiceImpl;

import io.wcm.testing.mock.aem.junit5.AemContext;

public class RefreshTokenServletTest {
    ...
    void doPost() throws IOException, ServletException {
        ...
        String refreshtoken = "f2AM7aZ2KfjnIqy8M3Ud98lWcBNa-5Zb";
        String responseValue=refreshTokenService.getRefreshTokenVal(refreshtoken,bearerToken);
        when(mockrefreshTokenService.getRefreshTokenVal(Mockito.anyString(),Mockito.anyString())).thenReturn(responseValue);
        MockSlingHttpServletRequest request = aemContext.request();
        MockSlingHttpServletResponse response = aemContext.response();
        request.addRequestParameter("refreshToken",refreshtoken);
