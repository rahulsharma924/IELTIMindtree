...
public class BrochuresSitemapSchedulerTest {

    @Mock
    private Scheduler scheduler;

    @Mock
    private BrochuresSitemapGeneratorService brochuresSitemapGeneratorService;

    private BrochuresSitemapSchedulerConfig config;

    private BrochuresSitemapScheduler schedulerComponent;

    @BeforeEach
    public void setUp() {
        MockitoAnnotations.initMocks(this);
        // Create a mock configuration
        config = mock(BrochuresSitemapSchedulerConfig.class);
        ...
        schedulerComponent = new BrochuresSitemapScheduler();
        schedulerComponent.scheduler = scheduler;
        schedulerComponent.brochuresSitemapGeneratorService = brochuresSitemapGeneratorService;
    }
    ...
    public void testActivateAndRun() throws IOException, ConfigurationException {
        ...
        verify(brochuresSitemapGeneratorService).generateBrochuresSiteMap();
    }
