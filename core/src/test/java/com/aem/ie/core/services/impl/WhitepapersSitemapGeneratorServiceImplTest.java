...
class WhitepapersSitemapGeneratorServiceImplTest {
    ...
    @Mock
    WhitepapersSitemapGeneratorConfig whitepapersSitemapGeneratorConfig;
    @InjectMocks
    WhitepapersSitemapGeneratorServiceImpl whitepapersSitemapGeneratorServiceImpl;
    ...
    @Test
    void activateTest(){
        whitepapersSitemapGeneratorServiceImpl.activate(whitepapersSitemapGeneratorConfig);
    }

    @Test
    void generateWhitepapersSiteMap() throws IOException, LoginException, RepositoryException {
        Asset asset = aemContext.create().asset("/content/dam/infinite-electronics/white-papers/fairview-microwave/pdfs",1600,900,"application/pdf");
        Asset asset1 = aemContext.create().asset("/content/dam/infinite-electronics/white-papers/fairview-microwave/pdfs/test1",1600,900,"application/pdf");
        ...
        when(resourceResolver.getResource(whitepapersSitemapGeneratorConfig.whitepapersRootPath())).thenReturn(resource);
        ...
        whitepapersSitemapGeneratorServiceImpl.generateWhitepapersSiteMap();
    }
