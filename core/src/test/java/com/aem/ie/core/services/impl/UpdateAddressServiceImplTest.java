...
public class UpdateAddressServiceImplTest {
	...
	@InjectMocks
	UpdateAddressServiceImpl updateAddressServiceImpl;
	private Map<String, String> configProps = new HashMap<String, String>();
	private Map<String,String> props = new HashMap<String, String>();
	@BeforeEach
    void setUp() {
		MockitoAnnotations.openMocks(this);
		CTAccountsConfig configuration = mock(CTAccountsConfig.class);
		...
		props.put("getUpdateAddressURL", "https://apim-iedtecomm-qa01.azure-api.net/account/fairview/updateAddress");
		updateAddressService = aemContext.registerInjectActivateService(new UpdateAddressServiceImpl(),props);
	}
	@Test()
    void updateaddressTest() throws ServletException, IOException, NullPointerException{
        ...
        CTAccountsConfig config = mock(CTAccountsConfig.class);
         ...
         responseValue = updateAddressService.updateAddress(accessToken, bearerToken, "jsonObject");
         when(mockupdateAddressService.updateAddress(Mockito.anyString(), Mockito.anyString(), Mockito.anyString())).thenReturn(responseValue);
         updateAddressServiceImpl.activate(config);
