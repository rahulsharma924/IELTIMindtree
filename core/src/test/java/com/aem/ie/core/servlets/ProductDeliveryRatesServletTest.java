...
import com.aem.ie.core.services.impl.ProductDeliveryRatesServiceImpl;

import io.wcm.testing.mock.aem.junit5.AemContext;

public class ProductDeliveryRatesServletTest {
	AemContext aemContext =  new AemContext(ResourceResolverType.JCR_MOCK);
	   
	ProductDeliveryRatesService productDeliveryRatesService;
    @Mock
    private ProductDeliveryRatesService mockproductDeliveryRatesService;
    private OLCCModuleService mockSampleOSGIService;
    @InjectMocks
    ProductDeliveryRatesServlet productDeliveryRatesServlet;
    ...
    void setUp() {
        ...
        props.put("getProductDeliveryRates", "https://apim-iedtecomm-qa01.azure-api.net/delivery/fairview/getProductDeliveryRates");
        productDeliveryRatesService = aemContext.registerInjectActivateService(new ProductDeliveryRatesServiceImpl(), props);
    }
    ...
    void doGetTest() throws ServletException, IOException {
            ...
            String MockProductdeliveryResponse = productDeliveryRatesService.getProductDeliveryRates(jsondata, bearerToken);
            when(mockproductDeliveryRatesService.getProductDeliveryRates(jsondata, bearerToken)).thenReturn(MockProductdeliveryResponse);
            MockSlingHttpServletRequest request = aemContext.request();
            MockSlingHttpServletResponse response = aemContext.response();
            request.addRequestParameter("jsonData",jsondata);
            request.addRequestParameter("bearerToken",bearerToken);
            productDeliveryRatesServlet.doPost(request, response);
