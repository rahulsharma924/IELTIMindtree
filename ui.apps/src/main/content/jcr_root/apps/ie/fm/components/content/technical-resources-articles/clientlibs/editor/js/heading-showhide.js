...
(function (document, $) {
    ...
    $(document).on("foundation-contentloaded", function (e) {
        ...
        checkboxShowHideHandler($(".cq-dialog-heading-showhide", e.target));
    });

    $(document).on("change", ".cq-dialog-heading-showhide", function (e) {
    ...
    function showHide(component, element) {
        ...
        var target = $(element).data("cqDialogHeadingShowhideTarget");
        var $target = $(target);
