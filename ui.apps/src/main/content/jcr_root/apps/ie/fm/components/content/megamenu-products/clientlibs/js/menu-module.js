(function ($, pluginName) {
  ...
  Plugin.prototype.init = function () {
    ...
    // handle subMenu links/triggers click events
	  if ($(window).width() > 833) {
        zeynep.find('[data-submenu]').on('mouseover', function (event) {
          ...
          // open the subMenu
          zeynep.find('.submenu.current').removeClass('current show');
          zeynep.find('.submenu > ul').removeClass('show');
          subMenuEl.addClass('opened current show');
          subMenuEl.find('> ul').addClass('show');
            if(subMenuEl.hasClass('third_level_nav')) {
              subMenuEl.closest('.sec_level_nav').addClass('current show');
              subMenuEl.closest('.sec_level_scroll').addClass('show');
              $('.promotion_box').removeClass('sec_level_promo').addClass('third_level_promo');
            }
            if(subMenuEl.hasClass('sec_level_nav')) {
              $('.promotion_box').removeClass('third_level_promo').addClass('sec_level_promo');
            }
