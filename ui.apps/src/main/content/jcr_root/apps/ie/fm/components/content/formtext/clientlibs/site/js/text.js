...
(function () {
  ...
  var maincontainer = document.getElementById("createaccount");
  if (maincontainer) {
    var fnameInput = $("#firstname");
    var fnameInputShip = $("#firstName");
    var lnameInput = $("#lastname");
    var lnameInputShip = $("#lastName");

    if (fnameInput) {
      fnameInput.parent().addClass("cmp-form-text");
      fnameInput
        .parent()
        .parent()
        .removeClass("aem-GridColumn aem-GridColumn--default--5")
        .addClass(
          "accfirstname aem-GridColumn--default--none aem-GridColumn aem-GridColumn--default--3 aem-GridColumn--offset--default--0"
        );
    }
    if (lnameInput) {
      lnameInput.parent().addClass("cmp-form-text");
      lnameInput
        .parent()
        .parent()
        .removeClass("aem-GridColumn aem-GridColumn--default--5")
        .addClass(
          "acclastname aem-GridColumn--default--none aem-GridColumn aem-GridColumn--default--3 aem-GridColumn--offset--default--0"
        );
    }
    if (fnameInputShip) {
      fnameInputShip.parent().addClass("cmp-form-text");
      fnameInputShip
        .parent()
        .parent()
        .removeClass("aem-GridColumn aem-GridColumn--default--5")
    ...
    if (lnameInputShip) {
      lnameInputShip.parent().addClass("cmp-form-text");
      lnameInputShip
        .parent()
        .parent()
        .removeClass("aem-GridColumn aem-GridColumn--default--5")
    ...
    if (cityName) {
      cityName.parentNode.parentNode.classList.add("acccityname");
    }

    var zipCode = document.getElementById("zipcode");
    if (zipCode) {
      zipCode.parentNode.parentNode.classList.add("acczipcode");
    }
  }
