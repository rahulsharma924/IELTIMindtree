function generalClickFnBalanced() {
    clearAll();
    ...
    if (check(x)) {
        ...
        calculateOutputBal(operands);
    }
}

function calculateOutputBal(operands) {
    let typeErrorImpedance = labelDataCalc.messages.typeErrorImpedance;
    ...
    document.getElementById("r").innerHTML = r.toPrecision(4) + " &Omega;";
}