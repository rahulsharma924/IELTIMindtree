    ...
    const getData = async () => {
      await fetch("/content/dam/infinite-electronics/json/fairview-microwave/utilities.json")
        ...
        .then((data) => {
          ...
          notAvailableLabel = data[0].labels.notAvailable;
          ...
          window.Handlebars.registerHelper(
            ...
            function (v1, v2, v3, options) {
              if (v1 === "Compliant" || v2 === "Compliant" || v3 === "Compliant") {
              ...
              <div class="select-estimate checkboxgrey">
                <div class="order-country-input zip-flex">
                  <input
                    ...
                    maxlength="10"
                  />
                  <button type="button" onclick="$pdpGlobal.zipValidate(${statusOversized ? "true": ""})"  
...
<div class="length-variant">
  ...
  productDetailsMethod = (content) => {
    return `<div class="order-details">
          ...
          <div class="order-details">
            ...
            <span class="order-items-price">${
              content.inventory > 0
                ? `${$pdpGlobal.formatNumber(content.inventory)}`
          ...
          <div class="order-details">
            ...
            <span class="order-items-price">${
              content.startingPrice
                ? `<span class="label-value pricingtierpriceNA"><span>$</span><span class="pricingtierprice">${$pdpGlobal.formatPrice(content.startingPrice)}</span></span>`
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <i class="fa fa-times" aria-hidden="true" id="closeId" data-dismiss="modal"></i>
      <div class="modal-body">
